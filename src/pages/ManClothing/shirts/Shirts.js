  ...
  return (
    <div className="p-6 ">
      ...
      <div>
        ...
        {man.shirts && man.shirts.length > 0 && (
          <div className="mt-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Shirts</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {man.shirts[0]?.products.map((product, index) => (
...
export default ManShirtCaegories;
